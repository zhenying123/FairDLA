    ...
    def save_results(self, args):
        for i in range(self.model_num):
            with open(f"{args.dataset}_tao{args.tem}_model{i}.txt", 'a') as f:
                f.write(f"jq, τ={args.tem}, γ={args.alpha}, lr_w={args.lr_w} , sample={args.rs},perturb_epsilon={args.per},epoch={args.epochs},avgy={args.avgy},hiiden={args.hidden} ,channel={args.channels},lr={args.lr},adv={args.adv}\n")
